...
def read_signal_pages(sf, read_signal_data, file_size, offset, page_size, epoch_length, channels_used, channels):
    ...
    if read_signal_data:
        for i in range(channels_used):
            signals[i] = signals[i] * channels[i].cal_factor * (channels[i].sensitivity_index/100.0) + channels[i].cal_offset
...
if __name__ == '__main__':
    ...
    temp_filterStringFileIndicator = "_not_refiltered_incl_sens"
